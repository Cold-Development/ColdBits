...
public class BitsMessageListener implements PluginMessageListener {

    public static final String CHANNEL = "BungeeCord";
    public static final String REFRESH_SUBCHANNEL = "coldbits:refresh";
    private final DataManager dataManager;

    public BitsMessageListener(ColdPlugin coldPlugin) {
    ...
    public void onPluginMessageReceived(String channel, Player attachedPlayer, byte[] message) {
        ...
        if (subchannel.equals(REFRESH_SUBCHANNEL)) {
            ...
            this.dataManager.refreshBits(uuid);
        }
    }
