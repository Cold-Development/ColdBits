...
public abstract class CommandHandler implements TabExecutor, NamedExecutor {
     ...
     */
    protected final Map<String, BitsCommand> registeredCommands = new HashMap<>();
    /**
     ...
     */
    public CommandHandler(ColdBits plugin, String cmd, CommandManager.CommandAliases aliases) {
        this.plugin = plugin;
        this.cmd = cmd;
     ...
     */
    public void registerCommand(BitsCommand command) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        BitsCommand subCommand = this.registeredCommands.get(subcmd);
        if (subCommand == null) {
        ...
        try {
            ...
            sender.sendMessage(ChatColor.RED + "A ColdBits error occurred while executing that command. Did you enter an invalid parameter?");
        }
