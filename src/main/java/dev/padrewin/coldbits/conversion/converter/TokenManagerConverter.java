package dev.padrewin.coldbits.conversion.converter;
...
import dev.padrewin.coldbits.conversion.CurrencyConverter;
    ...
    public void convert() {
        ...
        try {
            ...
            database.ordered(Integer.MAX_VALUE, data -> {
                ...
                int count = 0;
                SortedSet<SortedPlayer> bitsData = new TreeSet<>();
                for (Database.TopElement entry : data) {
                    try {
                        ...
                        bitsData.add(new SortedPlayer(uuid, name, amount));
                ...
                this.coldPlugin.getManager(dev.padrewin.coldbits.manager.DataManager.class).importData(bitsData, Collections.emptyMap());
